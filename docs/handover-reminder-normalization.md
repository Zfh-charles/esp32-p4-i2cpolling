...
CONFIG_REMINDER_POLL_DEFAULT_URL="http://114.245.179.11:8443/v1/devices/{device_id}/reminders/pending"
CONFIG_REMINDER_POLL_INTERVAL_SEC=60
CONFIG_REMINDER_ANNOUNCE_REPEAT=1
CONFIG_REMINDER_MQTT_WAKE=y
CONFIG_REMINDER_MQTT_WAKE_DEFAULT_BROKER="114.245.179.11:8883"
...
4. 验证连通:监视串口,确认
   ...
   - `ReminderTrace: poll_begin | url=http://114.245.179.11:8443/...` 正常返回
